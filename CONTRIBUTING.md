...
Report bugs at https://github.com/mlotfic/x_files/issues.
...
The best way to send feedback is to file an issue at https://github.com/mlotfic/x_files/issues.
...
Ready to contribute? Here's how to set up `x_files` for local development.

1. Fork the `x_files` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/x_files.git
   ```

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development:

   ```sh
   mkvirtualenv x_files
   cd x_files/
